  ...
  return (
    <Box className="form-page">
      <div className="initiation-title-container">
        ...
        <Text className="initiation-title">
          How would you like to enter your ESG Data?
        </Text>
      </div>
      <div className="initiation-options-container">
        <Box
          className={`initiation-option ${
            inputMethod == InitiationMethod.manual &&
            (colorMode == "dark"
              ? "initiation-option-active-dark"
              : "initiation-option-active-light")
          }`}
          _hover={{ bg: "secondary" }}
        ...
        >
          ...
          <div className="initiation-options-text-container">
            ...
            <Text fontSize={20} fontWeight={500} color="primary">
